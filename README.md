...
└──────────────┬─────────────────┘     └─────────────────────┬────────────────┘
               │                                             │
               │  /tumbller/mcp                              │  /fleet/mcp
               │  /tello/mcp                                 │  /tumbller/mcp
               │  /fakerover/mcp                             │  /tello/mcp
               │  → robot_submit_bid                         │  /fakerover/mcp
               │  → robot_execute_task                       │  → fleet_request_bids
               │  → robot_get_pricing                        │  → fleet_accept_bid
               │                                             │  → fleet_execute_task
